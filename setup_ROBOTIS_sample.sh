...
if [ -d ./robot_ws/src ]; then
    git clone https://github.com/ROBOTIS-GIT/turtlebot3.git robot_ws/src/turtlebot3
...
if [ -d ./simulation_ws/src ]; then
    ...
    git clone https://github.com/ROBOTIS-GIT/turtlebot3.git simulation_ws/src/turtlebot3
